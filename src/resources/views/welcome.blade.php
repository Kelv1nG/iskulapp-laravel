...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="bg-white min-h-screen flex flex-col justify-between">
    <nav class="bg-white p-4 sticky top-0 z-50">
      <div class="container mx-auto flex justify-between items-center">
        ...
        <a href="/" class="flex items-center">
          <img
            src="/iskulapp Logo/iskulapp Final Logo Horizontal.png"
            alt="Iskulapp Logo"
    ...
    >
      ...
      >
        <img
          src="/iskulapp Logo/Rectangle.png"
          alt="app mockup"
    ...
    <section class="py-8 mt-5">
      ...
      <div class="swiper mx-auto my-1 md:w-3/4" space-between="20">
        <div class="swiper-wrapper">
          <div class="relative w-full h-50 swiper-slide" data-aos="fade-up">
            <img
              src="./iskulapp Logo/SliderImage1.jpg"
              alt="Slider image 1"
          ...
          <div class="relative w-full h-50 swiper-slide" data-aos="fade-up">
            <img
              src="./iskulapp Logo/SliderImage2.png"
              alt="Slider image 2"
              class="w-full object-cover rounded-lg"
            />
            <div
          ...
          <div class="relative w-full h-50 swiper-slide" data-aos="fade-up">
            <img
              src="./iskulapp Logo/SliderImage3.jpg"
              alt="Slider image 3"
              class="w-full object-cover rounded-lg"
            />
            <div
          ...
          <div class="relative w-full h-50 swiper-slide" data-aos="fade-up">
            <img
              src="./iskulapp Logo/SliderImage4.jpg"
              alt="Slider image 4"
              class="w-full object-cover rounded-lg"
            />
            <div
    ...
    <div id="contact"></div>
    <section
      class="w-full bg-opacity-20 pb-10"
      style="background-color: var(--primary-color)"
    >
      <div class="w-full flex justify-center flex-col p-5" data-aos="fade-up">
        <h1 class="text-3xl text-center md:text-4xl font-bold text-blue-600">
          ...
          <form>
            <div class="mb-4">
              ...
              <input
                ...
                name="school-name"
                required
                class="mt-1 block w-full border rounded-md p-2 focus:ring-blue-500"
              />
            </div>
    ...
    <footer class="w-full">
      ...
      >
        <div class="p-10">
          <img
            src="/iskulapp Logo/iskulapp Final Logo Horizontal White.png"
            alt="Iskulapp Logo"
